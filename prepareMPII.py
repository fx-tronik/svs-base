...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 07:53:54 2018
MPII Interface https://github.com/mitmul/deeppose
@author: jakub
"""
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
def save_joints():
    joint_data_fn = '/home/jakub/data/MPII/data.json'
    mat = loadmat('/home/jakub/data/MPII/mpii_human_pose_v1_u12_1.mat')
...
def split_train_test():
    fp_test = open('/home/jakub/data/MPII/test_joints.csv', 'w')
    fp_train = open('/home/jakub/data/MPII/train_joints.csv', 'w')
    all_data = open('/home/jakub/data/MPII/data.json').readlines()
    N = len(all_data)
    N_test = int(N * 0.1)
    N_train = N - N_test
